...
router.get('/updateuser/id/:userid',Register.getUpdateuser);
router.post('/updateuser/id/:userid',Register.setUpdateuser);
...
router.post('/company/id/:companyid',Register.setChangeCompany);
